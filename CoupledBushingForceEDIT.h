#ifndef __CoupledBushingForceEDIT_h__
#define __CoupledBushingForceEDIT_h__
/* -------------------------------------------------------------------------- *
*                      OpenSim:  CoupledBushingForceEDIT.h                       *
* -------------------------------------------------------------------------- *
...
namespace OpenSim {
	...
	*/
	//OSIMPLUGIN_API 
	class CoupledBushingForceEDIT : public Force {
		OpenSim_DECLARE_CONCRETE_OBJECT(CoupledBushingForceEDIT, Force);
	...
	protected:
		...
		// Declare properties for stiffness matrix functions
		// for torque Z. Tz = f33(theta_z) + f34(x) + f35(y)
		OpenSim_DECLARE_OPTIONAL_PROPERTY(m_function33, Function,
			"Function defining the contribution of theta_z deflection to the moment about body_2's z axis.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(f_function34, Function,
			"Function defining the contribution of theta_z deflection to the moment about body_2's z axis.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(f_function35, Function,
			"Function defining the contribution of theta_z deflection to the moment about body_2's z axis.");

		// for force X. Tx = f44(x) + f45(y) + f43(theta_z)
		OpenSim_DECLARE_OPTIONAL_PROPERTY(f_function44, Function,
			"Function defining the contribution of x deflection to the force in the x direction.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(f_function45, Function,
			"Function defining the contribution of x deflection to the force in the x direction.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(m_function43, Function,
			"Function defining the contribution of x deflection to the force in the x direction.");

		// for force Y. Tx = f54(x) + f55(y) + f53(theta_z)
		OpenSim_DECLARE_OPTIONAL_PROPERTY(f_function55, Function,
			"Function defining the contribution of x deflection to the force in the x direction.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(f_function54, Function,
			"Function defining the contribution of x deflection to the force in the x direction.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(m_function53, Function,
			"Function defining the contribution of x deflection to the force in the x direction.");

		// other out of plane forces of completion -> diagonal funcitons only
		OpenSim_DECLARE_OPTIONAL_PROPERTY(f_function66, Function,
			"Function defining the contribution of y deflection to the force in the y direction.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(m_function11, Function,
			"Function defining the contribution of z deflection to the force in the z direction.");
		OpenSim_DECLARE_OPTIONAL_PROPERTY(m_function22, Function,
			"Function defining the contribution of z deflection to the force in the z direction.");
	...
	public:
		...
		// CONSTRUCTION
		CoupledBushingForceEDIT();
		CoupledBushingForceEDIT( std::string body1Name, SimTK::Vec3 point1, SimTK::Vec3 orientation1,
			std::string body2Name, SimTK::Vec3 point2, SimTK::Vec3 orientation2,
			SimTK::Mat66 stiffnessMat, SimTK::Mat66 dampingMat);
		CoupledBushingForceEDIT(const CoupledBushingForceEDIT &aForce);
		virtual ~CoupledBushingForceEDIT();

		CoupledBushingForceEDIT& operator=(const CoupledBushingForceEDIT &aForce);
		void copyData(const CoupledBushingForceEDIT &aForce);
		...
		void setF33(const OpenSim::Function& f1);
		void setF34(const OpenSim::Function& f1);
		void setF35(const OpenSim::Function& f1);
		void setF43(const OpenSim::Function& f1);
		void setF44(const OpenSim::Function& f1);
		void setF45(const OpenSim::Function& f1);
		void setF53(const OpenSim::Function& f1);
		void setF54(const OpenSim::Function& f1);
		void setF55(const OpenSim::Function& f1);
	...
	protected:
		...
		/**
		* Create a SimTK::Force which implements this CoupledBushingForceEDIT as part of the SimTK::MultibodySystem.
		*/
	...
	private:
		...
		void setupStiffnessFunctions();

		//=============================================================================
	};     // END of class CoupledBushingForceEDIT
	//=============================================================================
	//=============================================================================
} // end of namespace OpenSim

#endif // __CoupledBushingForceEDIT_h__